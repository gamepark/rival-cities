...
import { BuildFreeFactoryActionRule } from './actions/BuildFreeFactoryActionRule'

// Attention ! ne pas modifier l'ordre au risque de casser la description des cartes actions
...
export const actionRules: Record<ActionType, (game: MaterialGame) => PlayerTurnRule> = {
  ...
  [ActionType.BuildFreeFactory]: (game) => new BuildFreeFactoryActionRule(game),
