...
export class RivalCitiesSetup extends MaterialGameSetup<City, MaterialType, LocationType, RivalCitiesOptions> {
  ...
  test() {
    this.players.forEach((player) => {
      this.material(MaterialType.Product)
        .createItem({id: 1, location: { type: LocationType.PlayerProducts, player, id: 1 }})
      this.material(MaterialType.Product)
        .createItem({id: 1, location: { type: LocationType.PlayerProducts, player, id: 1 }})
      this.material(MaterialType.Product)
        .createItem({id: 1, location: { type: LocationType.PlayerProducts, player, id: 1 }})
      ...
      this.material(MaterialType.ShipCard)
        .createItem({id: 1, location: { type: LocationType.PlayerShipCards, player}})
      this.material(MaterialType.ShipCard)
        .createItem({id: 1, location: { type: LocationType.PlayerShipCards, player}})
      this.material(MaterialType.ShipCard)
        .createItem({id: 1, location: { type: LocationType.PlayerShipCards, player}})
      ...
      this.material(MaterialType.LawsuitCard)
        .createItem({id: 1, location: { type: LocationType.PlayerLawsuitCards, player}})
      this.material(MaterialType.LawsuitCard)
        .createItem({id: 1, location: { type: LocationType.PlayerLawsuitCards, player}})
      this.material(MaterialType.LawsuitCard)
        .createItem({id: 1, location: { type: LocationType.PlayerLawsuitCards, player}})
      this.material(MaterialType.AllianceCard)
        .createItem({id: 1, location: { type: LocationType.PlayerAllianceCards, player}})
      this.material(MaterialType.AllianceCard)
        .createItem({id: 1, location: { type: LocationType.PlayerAllianceCards, player}})
      this.material(MaterialType.AllianceCard)
        .createItem({id: 1, location: { type: LocationType.PlayerAllianceCards, player}})
      this.material(MaterialType.SpecialActionCard)
        .createItem({id: 1, location: { type: LocationType.PlayerSpecialActionCardsHand, player}})
      this.material(MaterialType.Letter)
        .createItem({location: { type: LocationType.PlayerLetterDeck, player}})
      this.material(MaterialType.Letter)
        .createItem({location: { type: LocationType.PlayerLetterDeck, player}})
      this.material(MaterialType.Letter)
        .createItem({location: { type: LocationType.PlayerLetterDeck, player}})
      ...
      this.material(MaterialType.StarToken)
        .createItem({location: { type: LocationType.PlayerStarTokens, player}})
    })
  }
