...
use [our template on GitHub](https://github.com/gamepark/board-rival-cities)
...
- `Rival Cities` => `Name of your Game`
- `RivalCities` => `NameOfYourGame`
- `rival-cities` => `name-of-your-game`
...
Once you have one Material type and one Location type, you can start to setup a new game in [RivalCitiesRules.ts](/rules/src/RivalCitiesRules.ts)
